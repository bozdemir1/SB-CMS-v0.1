      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <section class="login_content">
              ...
              <div>
                  <button class="btn btn-default" name="loggin" type="submit">Giriş Yap</button>
                <a class="reset_pass" href="#">Parolanızı unuttunuz mu?</a>
              </div>
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-paw"></i>Motorcular</h1>
                   <p>©2018 Salih Bozdemir tarafından kodlanmıştır.</p>
                </div>
              </div>
            </form>
          </section>
